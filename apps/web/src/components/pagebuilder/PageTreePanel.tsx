import { Rows3, Columns3, Type, ImageIcon, MousePointerClick, Link2, ArrowUpDown, Minus, Trash2, ChevronRight, ChevronDown } from 'lucide-react';
    ...
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="flex-1">
        <div className="px-2 pb-2 flex flex-col gap-0.5">
          ...
          {tree.map((row, rowIdx) => {
            const isRowExpanded = expandedRows[row.id] !== false; // default open
